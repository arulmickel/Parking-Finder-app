...
composeOptions {
    kotlinCompilerExtensionVersion = "1.5.14" // supplied by Compose toolchain, matches BOM
}
...
dependencies {
// Compose BOM ties all compose libs to same version
